//===================================================
//
// 影のモデルの描画 [shadow_charactermodel_renderer.cpp]
// Author:YUTO YOSHIDA
//
//===================================================
...
// 描画処理
//===================================================
void ShadowModelCharacterRenderer::Renderer(entt::registry& registry, const int nType)
{
	// シャドウマップじゃないなら
	...
	// レイヤー順にソートしたenityの取得
	auto EntityList = EntityManager::GetSortLayerEntity<RendererTag::ShadowMap>(registry);
